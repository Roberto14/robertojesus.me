...
const config: GatsbyConfig = {
  siteMetadata: {
    ...
    siteTitle: `Roberto's Corner`,
    siteTitleAlt: `Roberto's Corner - Blog posts about Web and Software Engineering`,
    siteHeadline: `Roberto Jesus personal blog for knowledge sharing about reactjs, software engineering and web development.`,
    siteUrl: `https://robertojesus.me/`,
    siteDescription,
    siteImage: `/facepalm.png`,
    siteLanguage: `en`,
    author: `@RobertoRJ`,
  },
  trailingSlash: `never`,
