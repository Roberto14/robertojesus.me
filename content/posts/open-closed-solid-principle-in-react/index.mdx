---
title: "Open-closed SOLID principal in React"
date: 2021-08-26
slug: "/open-closed-solid-principle-in-react"
banner: ./open_closed_principal.jpg
description: Open-closed principal is fundamental in extending software entities and React components are no different, check out how to do it!
tags:
    - react
...
to be the *de facto*, and the best method to extend React components, although the principal
usually refers to classical inheritance².

So I decided to write this article to exemplify how to apply the Open-closed principal
...
If to be compliant with the Open-closed principal, it required to use class-based inheritance,
...
```
The principal is properly applied as we didn't modify the original `Button` component and still
...
2. [Open-closed principal](https://en.wikipedia.org/wiki/Open%E2%80%93closed_principle)